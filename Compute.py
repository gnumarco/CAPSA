...
def get_distinct_elements(cursor):
    ...
    if user == "D":
        conv_file = "C:\\Users\\tr5568\\Desktop\\DAYANA\\CAPSA\\CONVERSION MATERIAL -SFAPO CAPSA.xlsx"
    elif user == "M":
...
def read_promo_file():
    ...
    if user == "D" and mode == 1:
        promo_file = "C:\\Users\\tr5568\\Desktop\\Dayana\\CAPSA\\PROMOCIONES_EROSKI_LYB_DDLL_2016_1802_VersII.xlsx"
        ...
        promo_file = "C:\\Users\\tr5568\\Desktop\\Dayana\\CAPSA\\PROMOCIONES_HLR.XLSX"
